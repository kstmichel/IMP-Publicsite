...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_docroot_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_docroot_dd.inc';
}
// </DDSETTINGS>

// If this is a pantheon environment include some configuration options
if( isset($_SERVER['PANTHEON_SITE_NAME']) ) {
  $site = $_SERVER['PANTHEON_SITE_NAME'];
  $env = $_ENV["PANTHEON_ENVIRONMENT"];

  require dirname(__FILE__) . '/settings.pantheon.php';
  if(file_exists(dirname(__FILE__) . "/settings.pantheon.{$env}.php")) {
